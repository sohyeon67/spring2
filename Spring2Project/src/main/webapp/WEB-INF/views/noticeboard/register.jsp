...
<script type="text/javascript" src="//dapi.kakao.com/v2/maps/sdk.js?appkey=7d167d0e7c356dcf5e9a74b0214b0d78&libraries=services"></script>
...
$(function() {
	...
	memAddress2.focusout(function() {
		...
		if((address1 != null && address1 != "") || (address2 != null && address2 != "")) {
			...
			mapContainer.style.display = "block";	// 보이게
		    mapOption = {
