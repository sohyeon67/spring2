...
public class MybatisController {
	 ...
	 * 				- 게시판 상세 화면 화면 만들기 (crud/read.jsp)
	 * 				- 여기까지 확인
	 * 
	 ...
	 * 				생성된 boardNo를 sql 쿼리가 담겨있는 insert 태그까지 넘어올 때, 넘겨주고 있는 파라미터(board)의 property인 boardNo에 셋팅된다.
	 ...
	 * 					최신 글 번호(boardNo)가 있으므로 글번호를 이용하여 상세보기 페이지로의 이동이 가능하다.
